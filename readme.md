Bamazon is a node CLI that allows a user to select a specific item and quanitiy of that item for purchase then out puts the total price for the selection.
